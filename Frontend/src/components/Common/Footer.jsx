    ...
    <footer className='border-t py-12 '>
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
          ...
          <div>
              ...
              <button type='submit' className='text-sm text-white bg-black px-6 py-3 rounded-r-md hover:bg-gray-800 transition-all'>Subscribe</button>
              </form>
          </div>
        ...
        <div className='container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6'>
          <p className='text-gray-500 text-sm tracking-tighter  text-center'>© 2025, ReactDev, All Rights Reserved.</p>
        </div>
    </footer>
  )
}
